...
outreg2 [m1 m2 m3 m4 m5] using 基准回归7.xls, replace  dec(4) addtext(Company FE, YES,Year FE, YES)
...
graph export 平行趋势检验7-1.tif, replace
...
outreg2 [m1 m2 m3 m4 m5 m6] using 稳健性检验7-2.xls, replace  dec(3) addtext(Company FE, YES,Year FE, YES)
...
esttab m1 m2 m3 m4, b(%6.4f) se(%6.4f)  star(* 0.1 ** 0.05 *** 0.01)  scalar(N r2) compress nogaps
outreg2 [m1 m2 m3 m4] using 稳健性检验7-3.xls, replace  dec(4) addtext(Company FE, YES,Year FE, YES)
...
est sto m4
esttab m1 m2 m3 m4, b(%6.4f) se(%6.4f)  star(* 0.1 ** 0.05 *** 0.01)  scalar(N r2) compress nogaps
outreg2 [m1 m2 m3 m4] using 稳健性检验7-4.xls, replace  dec(4) addtext(Company FE, YES,Year FE, YES)
...
forvalues i=1/500{
 ...
 qui merge 1:m id using  data.dta 
 gen treat = (_merge == 3)  
...
esttab m1 m2 m3 m4 m5, b(%6.4f) se(%6.4f)  star(* 0.1 ** 0.05 *** 0.01)  scalar(N r2) compress nogaps
outreg2 [m1 m2 m3 m4 m5] using 稳健性检验7-4时间.xls, replace  dec(4) addtext(Company FE, YES,Year FE, YES)
...
est sto m4
esttab m1 m2 m3 m4, b(%6.4f) se(%6.4f)  star(* 0.1 ** 0.05 *** 0.01)  scalar(N r2) compress nogaps
outreg2 [m1 m2 m3 m4] using 稳健性检验8.xls, replace  dec(4) addtext(Company FE, YES,Year FE, YES)
